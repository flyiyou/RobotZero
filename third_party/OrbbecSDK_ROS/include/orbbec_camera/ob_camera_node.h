...
class OBCameraNode {
 ...
 private:
  ...
  bool getFloodStatusCallback(GetBoolRequest& request, GetBoolResponse& response);
  bool getFloodLevelCallback(GetInt32Request& request, GetInt32Response& response);
  bool setFloodLevelCallback(SetInt32Request& request, SetInt32Response& response);
  bool getIRSwitchStatusCallback(GetInt32Request& request, GetInt32Response& response);
  bool rebootDeviceCallback(std_srvs::EmptyRequest& request, std_srvs::EmptyResponse& response);
 ...
 private:
  ...
  ros::ServiceServer get_flood_status_srv_;
  ros::ServiceServer get_flood_level_srv_;
  ros::ServiceServer set_flood_level_srv_;
  ros::ServiceServer get_ir_channel_srv_;
  ros::ServiceServer reboot_device_srv_;
